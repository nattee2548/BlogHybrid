...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        // สร้าง database ถ้ายังไม่มี และ apply migrations ทั้งหมด
    ...
    catch (Exception ex)
    {
        ...
        // Re-throw เพื่อไม่ให้ app start ถ้า migration ล้มเหลว
        throw;
    }
}

// ========================================================================
// DATABASE SEEDING: Seed ข้อมูลเริ่มต้น (Roles, Admin User, etc.)
// ========================================================================
using (var scope = app.Services.CreateScope())
{
    var services = scope.ServiceProvider;
    ...
    catch (Exception ex)
    {
        ...
        // ไม่ throw เพราะ seeding ล้มเหลวไม่ควรหยุด app
    }
}
