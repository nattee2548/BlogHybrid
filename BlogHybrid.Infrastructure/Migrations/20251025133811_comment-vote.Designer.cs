...
namespace BlogHybrid.Infrastructure.Migrations
{
    ...
    [Migration("20251025133811_comment-vote")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogHybrid.Domain.Entities.Comment", b =>
                {
                    ...
                    b.Property<int>("ReactionAngryCount")
                        .HasColumnType("integer");

                    b.Property<int>("ReactionHahaCount")
                        .HasColumnType("integer");

                    b.Property<int>("ReactionLikeCount")
                        .HasColumnType("integer");

                    b.Property<int>("ReactionLoveCount")
                        .HasColumnType("integer");

                    b.Property<int>("ReactionSadCount")
                        .HasColumnType("integer");

                    b.Property<int>("ReactionWowCount")
                        .HasColumnType("integer");

                    b.Property<int>("TotalReactionCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BlogHybrid.Domain.Entities.CommentReaction", b =>
                {
                    b.Property<int>("CommentId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UserId", "ReactionType");

                    b.ToTable("CommentReactions", (string)null);
                });

            modelBuilder.Entity("BlogHybrid.Domain.Entities.CommentVote", b =>
                {
                    b.Property<int>("CommentId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BlogHybrid.Domain.Entities.CommunityCategory", b =>
                {
            ...
            modelBuilder.Entity("BlogHybrid.Domain.Entities.Category", b =>
                {
                    b.HasOne("BlogHybrid.Domain.Entities.Category", "ParentCategory")
